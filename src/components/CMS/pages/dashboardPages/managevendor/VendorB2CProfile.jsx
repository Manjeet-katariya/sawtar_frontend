...
const VendorB2CProfile = () => {
  ...
  const fetchVendor = async () => {
    setLoading(true);
    try {
      const response = await apiService.get(`/vendor/b2c?vendorId=${id}`);
  ...
  const getDocumentsByType = () => {
    const docs = {
      ...
      address_proof: vendor.documents.address_proof ? [{ ...vendor.documents.address_proof, type: 'address_proof' }] : [],
      gst_certificate: vendor.documents.gst_certificate ? [{ ...vendor.documents.gst_certificate, type: 'gst_certificate' }] : [],
    };
    return docs;
  };
    ...
    <div className="min-h-screen bg-gray-100 py-8">
      <div className="max-w-7xl mx-auto px-4">
        <div className="mb-8">
          ...
          <h1 className="mt-2 text-2xl font-bold">B2C Vendor Profile</h1>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <Card className="shadow-md">
            ...
            <div className="flex justify-center mb-4">
              {vendor.store_details?.logo ? (
                <Avatar src={`http://localhost:5000/${vendor.store_details.logo}`} size={96} />
              ) : (
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <p>{vendor.store_details?.store_name || '--'}</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p>{vendor.store_details?.store_type || '--'}</p>
              </div>
              <div>
          ...
          <Card className="shadow-md">
            ...
            <div className="grid grid-cols-1 gap-4">
              <div>
                ...
                <p>{vendor.store_details?.store_address || '--'}</p>
              </div>
              <div>
                <p className="text-sm text-gray-500">Pincode</p>
                <p>{vendor.store_details?.pincode || '--'}</p>
              </div>
              <div>
                <p className="text-sm text-gray-500">Website</p>
                <p>{vendor.store_details?.website || '--'}</p>
              </div>
              <div>
                <p className="text-sm text-gray-500">Store Description</p>
                <p>{vendor.store_details?.store_description || '--'}</p>
              </div>
              <div>
                ...
                <div className="mt-2">
                  {vendor.store_details?.social_links ? (
                    <>
                      {vendor.store_details.social_links.facebook && (
                        <p>Facebook: {vendor.store_details.social_links.facebook}</p>
                      )}
                      {vendor.store_details.social_links.twitter && (
                        <p>Twitter: {vendor.store_details.social_links.twitter}</p>
                      )}
                      {vendor.store_details.social_links.instagram && (
                        <p>Instagram: {vendor.store_details.social_links.instagram}</p>
                      )}
                      {vendor.store_details.social_links.linkedin && (
                        <p>LinkedIn: {vendor.store_details.social_links.linkedin}</p>
                      )}
                      {vendor.store_details.social_links.youtube && (
                        <p>YouTube: {vendor.store_details.social_links.youtube}</p>
                      )}
                    </>
                  ) : (
          ...
          <Card className="shadow-md">
            <h2 className="text-lg font-semibold mb-4">Registration & Bank Details</h2>
            <div className="grid grid-cols-2 gap-4">
              <div>
              ...
              <div>
                ...
                <p>{vendor.registration?.business_license_number || '--'}</p>
              </div>
              <div>
                <p className="text-sm text-gray-500">Shop Act License</p>
                <p>{vendor.registration?.shop_act_license || '--'}</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p>{vendor.bank_details?.upi_id || '--'}</p>
              </div>
              <div>
            ...
            <div className="grid grid-cols-1 gap-4">
              <div>
                ...
                {vendor.contacts?.primary_contact ? (
                  <>
                    <p>Name: {vendor.contacts.primary_contact.name || '--'}</p>
                    <p>Designation: {vendor.contacts.primary_contact.designation || '--'}</p>
                    <p>Email: {vendor.contacts.primary_contact.email || '--'}</p>
                    <p>Mobile: {vendor.contacts.primary_contact.mobile || '--'}</p>
                    <p>WhatsApp: {vendor.contacts.primary_contact.whatsapp || '--'}</p>
                  </>
                ) : (
                  <p className="text-gray-500">No primary contact provided</p>
                )}
              </div>
              <div>
                <h3 className="text-sm font-medium mb-2 mt-4">Support Contact</h3>
                {vendor.contacts?.support_contact ? (
                  <>
                    <p>Name: {vendor.contacts.support_contact.name || '--'}</p>
                    <p>Designation: {vendor.contacts.support_contact.designation || '--'}</p>
                    <p>Email: {vendor.contacts.support_contact.email || '--'}</p>
                    <p>Mobile: {vendor.contacts.support_contact.mobile || '--'}</p>
                    <p>WhatsApp: {vendor.contacts.support_contact.whatsapp || '--'}</p>
                  </>
                ) : (
                  <p className="text-gray-500">No support contact provided</p>
                )}
              </div>
            </div>
          </Card>
          ...
          <Card className="shadow-md">
            ...
            {vendor.store_details?.categories && vendor.store_details.categories.length > 0 ? (
              <List
                dataSource={vendor.store_details.categories}
          ...
          <Card className="shadow-md">
            ...
            <div className="grid grid-cols-1 gap-4">
              <div>
                <p className="text-sm text-gray-500">Delivery Modes</p>
                <p>{vendor.operations?.delivery_modes?.join(', ') || '--'}</p>
              </div>
              <div>
                <p className="text-sm text-gray-500">Return Policy</p>
                <p>{vendor.operations?.return_policy || '--'}</p>
              </div>
              <div>
                <p className="text-sm text-gray-500">Average Delivery Time (Days)</p>
                <p>{vendor.operations?.avg_delivery_time_days || '--'}</p>
              </div>
            </div>
          </Card>
          ...
          <Card className="shadow-md">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <p>{vendor.performance?.ratings || '--'}</p>
              </div>
              <div>
                <p className="text-sm text-gray-500">Reviews Count</p>
                <p>{vendor.performance?.reviews_count || '--'}</p>
              </div>
              <div>
                <p className="text-sm text-gray-500">On-Time Delivery Rate</p>
                <p>{vendor.performance?.on_time_delivery_rate ? `${vendor.performance.on_time_delivery_rate}%` : '--'}</p>
              </div>
              <div>
                <p className="text-sm text-gray-500">Cancellation Rate</p>
                <p>{vendor.performance?.cancellation_rate ? `${vendor.performance.cancellation_rate}%` : '--'}</p>
              </div>
              <div className="col-span-2">
                <p className="text-sm text-gray-500">Top Selling Products</p>
                <p>{vendor.performance?.top_selling_products?.join(', ') || '--'}</p>
              </div>
            </div>
          </Card>
